...
class Produk
{
    public $nama , $harga , $jumlah , $metode;
    ...
    public function cashback(){
        ...
        if($this->metode == "M-Banking"){
            return  $diskonn = 0.025 * $this->hasil(); 
        }
        else if($this->metode == "Gopay"){
            return  $diskonn = 0.10 * $this->hasil(); 
        }
        else if($this->metode == "pickUp"){
            return  $diskonn = 0.015 * $this->hasil(); 
        }
        else if($this->metode == "Cash"){
            return  $diskonn = 0 * $this->hasil(); 
        }
